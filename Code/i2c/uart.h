...
/**
 * @brief Initializes the UART with a specified baud rate and redirects stdio.
 * @note F_CPU must be defined in your project (e.g., in platformio.ini).
 * @param baud The desired baud rate (e.g., 9600).
 */
void uart_init(unsigned long baud);

/**
 * @brief Sends a single character over UART. This is the backend for printf.
 * @param c The character to send.
 * @param stream The file stream (unused, but required for printf).
 * @return 0 on success.
 */
